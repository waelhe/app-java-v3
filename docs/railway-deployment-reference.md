...
> **الحالة (محدّثة 2026-09-18T18:15Z): نشِط — Railway هو منصة الإنتاج الحية (طبقة التطبيق)؛ قناة قاعدة البيانات = Neon الخارجية منذ 2026-09-18T01:58Z**
>
> **النشر الحي (آخر تحقق 2026-09-18T18:15Z — قناة GraphQL v2 مقروءة):** `https://app-java-v3-production-d020.up.railway.app` (بروفايل prod) — **النشرة الحاملة الحالية `117830d3` SUCCESS 2026-09-18T18:15:03Z تحمل main `02903d9`** (L46 جسر العقار المجتمعي PR #340 — ختام المرحلة الأولى للخطة المجتمعية؛ إقلاع 15.297s؛ `Successfully validated 64 migrations` + `applied 1 ... now at version v63`) عبر القناة الذاتية (fork `waelhe88-coder/app-java-v3` — مزامنته المجدولة، نافذة cron الدقيقة 11). **قناة قاعدة البيانات الحالية: Neon الخارجية** (`ep-weathered-pond-b2vgv0jc.c-6.eu-central-1.aws.neon.tech/neondb`) منذ 2026-09-18T01:58Z — **سجل Flyway الحي عليها: 64 مدخلًا، الفهرس V63**؛ سلسلة الوصول الكاملة بقياسها في SYSTEM.md §15 (`cf599b38` طبّقت v61+v62 على postgres-18 عند 19:47:18Z ← `39c63aa5` فشل انتقال اعتماد flyway_migrator 28P01 ← `94a64138` السلسلة الكاملة 63 مدخلًا على Neon عند 01:58:09Z ← `25ed9e65` ← `05ac819b` [5b33488] ← `5316ec7f` [e048c22 — docs-only] ← `2364674a` [957e9ac — docs-only] ← **`117830d3` [02903d9 — الحالية]**). **خدمة postgres-18 = قناة تراثية منذ الانتقال** (سجلها بلغ v62 عند 2026-09-17T19:47:18Z ولم تعد قناة التطبيق — لا تُفحص أثناء الحوادث). الدخان الحي 2026-09-18T18:15Z: liveness/readiness UP + دروز 401 بعقد problem+json (L42 للتغذية/التعليقات + L41 العضوية + أساس AI + استمرارية L38 + تفضيلات L22/L46). (سجل تاريخي مؤرخ: آخر تحقق سابق 2026-09-05 كان fork = `78df7f8` = #212 والقنوات خضراء بعده؛ ومعرّف النشرة حينها كان غير مقروء بتوكن تلك الجولة — قناة GraphQL مقروءة الآن)
