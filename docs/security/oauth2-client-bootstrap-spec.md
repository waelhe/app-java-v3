...
| البند | القيمة |
|------|--------|
| الحالة | **منفّذ ومدمج** (main `773558e` + المتابعة [#185](https://github.com/waelhe/app-java-v3/pull/185) → `1ebdf07` 2026-09-03، CI أخضر ×2) |
| التاريخ | سبتمبر 2026 |
...
| PR الفعلي | [#184](https://github.com/waelhe/app-java-v3/pull/184) — **مدمج** (773558e، 2026-09-02)؛ المتابعة [#185](https://github.com/waelhe/app-java-v3/pull/185) **مدمجة** (`1ebdf07`، 2026-09-03، CI أخضر ×2): استورد يتيم + javadoc + تأكيد id_token الحي + §3-ج |
