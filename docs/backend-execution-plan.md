...
| 9. OpenAPI documentation | In progress | Baseline YAML served at `/v3/api-docs.yaml` and `/openapi.yaml`, with `/docs` landing page; next step is full schema coverage. |
