...
### P1 — طبقة الشيفلة (PR واحد كامل الحوكمة — بعد كلمة «نفّذ») 🔄 منفَّذة على الفرع — PR #300 مفتوح تحت الدورة (كلمة المستخدم «بدء P1 ونفذ» 2026-09-13 — الشرط المسبق أُقفل بالقياس: PR #297 بجذر qudsayya [delete_childless كان يحذف al-hamah المزروعة] ثم PR #299 بتبنّي 14 ملاحظة CodeRabbit من الجذر + 4 جولات CI للشرائح التي لم تُشغَّل قط — main = c85e759)
