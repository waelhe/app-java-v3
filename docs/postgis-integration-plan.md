...
| **D-P12** | **مفتاح المخبأة يُرفع مع كل تغيير المكوّن:** `search-results-v3 → v4` + رفع PREFIX مولد المفتاح (l32→l34 كمرحلة) + مقاطع إحداثيات مطبَّعة (scale-6 وradius مترًا صحيحًا) تبقي المفتاح injective | سابقة D-R6/#241 (تعليق «Bump together with the other three names») |
