...
|---|---|---|---|---|
| **الحالية على main** — استُبدلت بكلمة المستخدم «تخلّص من نسخة graph القديمة» 2026-09-19 (دفعة الاستبدال هذه نفسها) | **main نفسه** (`.ua/` المتتبعة) | `957e9ac` (2026-09-19T07:48Z، 918 ملفاً) | 3813 / 5357 | أحدث: `imports` 1004 + `migrates` 81 + `calls` 202 + `tested_by` 131 |
