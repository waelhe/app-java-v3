...
class GlobalExceptionHandlerTest {
    ...
    void shouldMapRateLimitTo429WithStandardType() {
        ...
        RequestNotPermitted ex = RequestNotPermitted.createRequestNotPermitted(RateLimiter.ofDefaults("payments"));
        ProblemDetail pd = handler.handleRateLimited(ex, request);
