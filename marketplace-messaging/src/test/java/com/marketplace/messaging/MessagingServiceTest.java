...
class MessagingServiceTest {
    ...
    @Test
    void createConversation_savesNewWithDerivedParticipantB() {
    ...
    @Test
    void createConversation_rejectsNotParticipant() {
        UUID bookingId = UUID.randomUUID();
        UUID participantA = UUID.randomUUID();
        BookingInfo bookingInfo = new BookingInfo(
        ...
        assertThrows(AccessDeniedException.class,
                () -> service.createConversation(participantA, bookingId));
    }
    ...
    void createConversation_rejectsCancelledBooking() {
        ...
        UUID participantB = UUID.randomUUID();
        BookingInfo bookingInfo = new BookingInfo(
                participantB, participantA, "CANCELLED", 5000L, "SAR", Instant.now(), Instant.now());
