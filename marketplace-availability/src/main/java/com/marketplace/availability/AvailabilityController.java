...
public class AvailabilityController {
    ...
    public ResponseEntity<ProviderAvailabilityRule> addRule(@PathVariable UUID providerId, @Valid @RequestBody AvailabilityRuleRequest request) {
        ProviderAvailabilityRule rule = availabilityService.addRule(providerId, request.dayOfWeek(), request.startsAt(), request.endsAt(), request.slotMinutes());
    ...
    @PreAuthorize("hasAnyRole('PROVIDER','ADMIN')")
    public ResponseEntity<ProviderTimeOff> addTimeOff(@PathVariable UUID providerId, @Valid @RequestBody TimeOffRequest request) {
        return ResponseEntity.ok(availabilityService.addTimeOff(providerId, request.startsAt(), request.endsAt(), request.reason()));
    }
