...
## Self-Maintenance Layer — الطبقة تُطهّر نفسها وتُقرأ بنيتها (2026-09-04) 🏗️ فرع `feat/self-maintenance-layer` (بانتظار CI والدمج)
...
**ما بعد الدمج:** بانتظار CI ×2 على الرأس ثم الدمج squash وفق §14.3 — سجل النشر يُحدَّث في دفعة truth-sync تالية عند أول نشر كودي (سياسة التقارب #207: إعادة بناء الفروق التوثيقية لا تُسجَّل؛ هذا فرع كودي فسيُسجَّل).
