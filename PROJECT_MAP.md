...
## [ORPHANS & PENDING]
- [ ] توثيق مصفوفة توافق الإصدارات (Boot/Java/Maven/plugins) داخل `docs/dependency-matrix.md`.
- [ ] إضافة Runbook تشغيل production (profiles, env vars, health checks).
- [ ] إضافة سيناريوات chaos/timeout لاختبارات Payments وMessaging.
- [ ] توحيد سياسة error codes عبر جميع controllers.
